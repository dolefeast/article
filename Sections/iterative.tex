...
Interpreting Eq. \eqref{eq:A0-general-iterative} as an update map on $A_{0,\lambda}^{\kappa-1}$, we identify the iterative scheme with an infinite-dimensional fixed-point problem. That is, for each $\lambda$, we seek $A_{0,\lambda}$ such that
\begin{align}
